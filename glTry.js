...
var zoom = function(e) {
    e.preventDefault();
    view_matrix[14] = view_matrix[14]- (e.deltaY * -0.1);
}
...
function computePolygonPositions(sides, radius)
{
    let positions = []
    let inices = []
    ...
    return [positions, inices]
}

var addpol = document.getElementById("addpol");
addpol.onclick = () => {
    let sides = document.getElementById("polsides").value;
    console.log(sides)
    console.log(computePolygonPositions(sides,1))
}